<nav id="nav" class="navbar navbar-expand-lg navbar-light fixed-top">
  <div class="container">
    <a class="navbar-brand primary-font" href="./"><img width="28" src="https://instaroadtax.my/img/irm_logo.svg" alt=""> <strong>InstaRoadtax<span style="color:#554df0;">.my</span></strong></a>
    ...
    <div class="collapse navbar-collapse justify-content-around mt-4 mt-md-0" id="navbarToggler">
      <ul class="navbar-nav">
        ...
        <li class="nav-item pt-2">
          <a class="nav-link" href="#faq-list">Soalan Lazim</a>
        </li>
        <li class="nav-item pt-2">
